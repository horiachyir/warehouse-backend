...
SECRET_KEY = 'django-insecure--+m071=))u^nl*@xd&%*fu_*c8tg6*1x(pny*3ba_$bs6s95(a'
...
WSGI_APPLICATION = 'depot_hub.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': config('DB_ENGINE', default='django.db.backends.postgresql'),
        'NAME': config('DB_NAME', default='warehouse_db'),
        'USER': config('DB_USER', default='warehouse_user'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Warehouse API',
    'DESCRIPTION': 'API documentation for Warehouse monitoring system',
    'VERSION': '1.0.0',
